...
if __name__ == '__main__':
    ...
    parser.add_argument("--emb_dropout", type=float, default=0.3, nargs="?", help="emb_dropout.")
    parser.add_argument("--vis_dropout", type=float, default=0.6, nargs="?", help="vis_dropout.")
    parser.add_argument("--txt_dropout", type=float, default=0.1, nargs="?", help="txt_dropout.")
