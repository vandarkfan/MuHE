        ...
        for it in range(1, self.num_iterations + 1):
            ...
            if it % param['eval_step'] == 0:
                ...
                with torch.no_grad():
                    ...
                    print('Epoch=%d, Test MRR=%f, Hits@10=%f, Hits@3=%f, Hits@1=%f' % (it, t_mrr, t_hit10, t_hit3, t_hit1))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--emb_dropout", type=float, default=0.2, nargs="?", help="emb_dropout.")
    parser.add_argument("--vis_dropout", type=float, default=0.6, nargs="?", help="vis_dropout.")
